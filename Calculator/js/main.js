...
const Calculator = {
    ...
    First_Operand: null,
    //this chekcs whether or not the second operand has been input
...
function Handle_Operator(Next_Operator) {
    ...
    //when an operator key is pressed, it converts the current number 
    //displayed on the screen to a number and then store the result in
    //Calculator.First_Operand if it doesn't already exist
    const Value_of_Input = parseFloat(Display_Value);
    //checks if an operator and exits from the function
    ...
    if (First_Operand == null) {
        ...
        //if operator exists, property lookup us performed for the operator
 ...
 function Update_Display() {
    const display = document.querySelector('.calculator-screens');
