...
function placeXOrO(squareNumber)  {
    ...
    //The .some() methood is used to check each element of selectedSquare array
    ...
    function computersTurn() {
        ...
        let pickASqaure;
        //This condition alllows our while loop to keep trying if a square is selected already
        while(!success) {
...
//This function makes our boy element temporarily unclickable
function disableClick() {
    //This makes our body unclickable
    body.style.pointerEvents = 'none';
    //This makes ourbody click able again after 1 second
...
//This line access the HTML canvas element 
    ...
    let x1 = coordX1
        ...
        x2 = coordX2
         ...
         y2 = coordY2
         //This variabvle stores temporary x axis data we update in our animation loop
         x = x1
         //This variabvle stores temporary y axis data we update in our animation loop
         y = y1
    ...
    //THis line our main animation loop
    animateLineDrawing();
